...
contract('Fee Controller TEX', function ([_, admin, feeController, feeRecipient, recipient, otherAddress, owner]) {
    ...
    beforeEach(async function () {
        ...
        // const newSupplyController = await this.token.supplyController()
        // console.log(`***************** newOwner`, newOwner)
        // console.log(`****************** underscore`, _)
        // console.log(`***************** newSupplyController`, newSupplyController)

        await this.token.setSupplyController(owner, { from: owner })


        await this.token.setFeeController(owner);
        // const feeAddress = await this.token.feeRecipient();
